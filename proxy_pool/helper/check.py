...
from proxy_pool.util.six import Empty
from threading import Thread
from datetime import datetime
from proxy_pool.util.webRequest import WebRequest
from proxy_pool.handler.logHandler import LogHandler
from proxy_pool.helper.validator import ProxyValidator
...
class _ThreadChecker(Thread):
    ...
    def __ifRaw(self, proxy):
        # print('=====__ifRaw=======', proxy.last_status,self.name, proxy.proxy.ljust(23))
