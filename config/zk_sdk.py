...
class ServiceRegister(object):
    def __init__(self, hosts="127.0.0.1:2181", auth_data="test:test", read_only=True, logger=None):
        """
        服务注册
        ...
        self._zk = KazooClient(hosts, auth_data=auth_data, read_only=read_only, logger=logger)
        self._zk.start()
